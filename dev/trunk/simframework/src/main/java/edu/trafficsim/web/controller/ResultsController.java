...
public class ResultsController extends AbstractController {
	...
	public String view(Model model) {
		...
		model.addAttribute("linkIds", result.getLinkIds());
		model.addAttribute("vehicleIds", result.getVehicleIds());
